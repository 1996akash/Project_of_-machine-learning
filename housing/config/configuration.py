...
from housing.constant import CONFIG_FILE_NAME, CONFIG_FILE_PATH, CURRENT_TIME_STAMP, DATA_INGESTION_ARTIFACT_DIR, DATA_INGESTION_CONFIG_KEY, DATA_INGESTION_DOWNLOAD_URL_KEY, DATA_INGESTION_RAW_DATA_DIR_KEY, DATA_INGESTION_TGZ_DOWNLOAD_DIR_KEY, ROOT_DIR, TRAINING_PIPELINE_ARTIFACT_DIR_KEY, TRAINING_PIPELINE_CONFIG_KEY, TRAINING_PIPELINE_NAME_KEY
...
##This function return entity----When I call this   def get_data_ingestion_config(self) 
# ## i got DataIngestionConfig As entity  same for all the config
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            ingested_train_dir = os.path.join(ingested_test_dir,data_ingestion_info[DATA_INGESTION_TRAIN_DIR_KEY])
            ingested_test_dir=os.path.join(ingested_train_dir,data_ingestion_info[DATA_INGESTION_TEST_DIR_KEY])



            
            data_ingestion_config=DataIngestionConfig(dataset_download_url=dataset_download_url, tgz_download_dir=tgz_download_dir, raw_data_dir=raw_data_dir, ingested_train_dir=ingested_train_dir, ingested_test_dir=ingested_test_dir)
    ...
    def get_model_trainer_config(self) -> ModelTrainingConfig:
        try:
            ...
            model_trainer_config = ModelTrainingConfig(trained_model_file_path=trained_model_file_path,base_accuracy=base_accuracy,model_config_file_path=model_config_file_path
            )
